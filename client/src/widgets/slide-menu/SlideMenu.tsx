        ...
        <>
          <header className={HeaderStyle.container_static}>
            <div className={HeaderStyle.container_fixed}>
              ...
              <div className={HeaderStyle.burgerImageContainer} onClick={() => setIsModalOpen(true)}>
                <BurgerImage viewBox='0 0 24 14'/>
              </div>
            </div>
          </header>
          <BottomModal isOpen={isModalOpen} setIsOpen={setIsModalOpen}>
            <div className={cls.link_container}>
              <MainBtn state={"gray"} to={"/admin/home"} onClick={() => setIsModalOpen(false)}>
              ...
              <MainBtn state={"gray"} to={"/admin/feed"} onClick={() => setIsModalOpen(false)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              <MainBtn state={"gray"} to={"/admin/settings"} onClick={() => setIsModalOpen(false)}>
              ...
              <MainBtn state={"gray"} to={"/admin/analytics"} onClick={() => setIsModalOpen(false)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
