import cls from "@src/widgets/slide-menu/SlideMenu.module.scss";
...
import {logout} from "@src/app/manager/effect/adminAuth.effect";
...
import CrossImage from "@src/shared/assets/icons/header/cross.svg"
...
export const SlideMenu = () => {
  ...
  return (
    <>
      <div className={useClass([cls.burgerSidebar, !globalResize.isScreenMd && !isSidebarOpen? cls["open"] : cls["closed"]])}>
        <div className={cls.burgerImageContainer} onClick={() => setIsSidebarOpen(true)}><BurgerImage/></div>
      </div>
      <header className={useClass([cls.header, !globalResize.isScreenMd ? (isSidebarOpen ? cls["open"] : cls["closed"]) : ""])}>
        <div className={cls.sidebarHeader}>
          <Link to={"/"} className={cls.link_home}>
            <Logo/>
          </Link>
          <div className={cls.crossIcon} onClick={() =>setIsSidebarOpen(false)}>
            <CrossImage/>
          </div>
        </div>
        ...
        <div className={cls.link_container}>
          ...
          <MainBtn state={"gray"} to={"/admin/analytics"}>
            ...
            <p className={TextModule.p_14}>Аналитика</p>
          </MainBtn>
        </div>
        ...
        <div className={cls.logout_container}>
          <MainBtn state={"black"} onClick={handleClick}>
            ...
            <p className={TextModule.p_14}>Выйти</p>
          </MainBtn>
        </div>
      </header>
    </>
